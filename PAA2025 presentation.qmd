...
-   [Caring for a spouse]{style="color: #E74C3C"}
-   [In-direct care]{style="color: #F39C12"}
:::
...
df.lfp <- read.csv("https://ourworldindata.org/grapher/female-employment-to-population-ratio.csv?v=1&csvType=filtered&useColumnShortNames=true&time=1970..latest&country=CAN~USA~KOR~SWE")

df.time <- read.csv("https://ourworldindata.org/grapher/time-spend-in-domestic-work-female-vs-male.csv?v=1&csvType=filtered&useColumnShortNames=true&tab=table&time=2021&showSelectionOnlyInTable=1&country=SWE~USA~CAN~KOR") %>%
#  filter(Code == "CAN" | Code == "USA" | Code == "KOR" | Code == "SWE") %>%
