...
```{r warning = FALSE, fig.width=14, fig.asp=.56}
...
:::: aside
::: {style="font-size: 70%; color: 'grey40';"}
Predicted probability of marriage/parenthood by age 30, adjusted for birth decade, race, maternal education and employment, and family structure;  
